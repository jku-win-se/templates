...
%%% Last Update to template: Sep 2026                                  %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%CONFIG-PROPERTY 0: Chapter Style: select between madsen and veelo     %%%
...
%%%% Language selection              %%%% 
%%%% Uncomment                       %%%% 
%%%% \chapterstyle{madsen} or        %%%% 
%%%% \chapterstyle{veelo}            %%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% Comment in the preferred chapter style
\chapterstyle{madsen}
%\chapterstyle{veelo}
...
\usepackage[a4paper,top=35mm,bottom=50mm,outer=20mm,inner=35mm,]{geometry}
\begin{document}
