...
\documentclass[rgb,pdftex,oneside,12pt,chapterprefix,cleardoublepage=empty,listof=totoc,bibliography=totoc,numbers=noenddot,headsepline,%footsepline,footinclude=false,headinclude=false
]{memoir}
\usepackage{import}
